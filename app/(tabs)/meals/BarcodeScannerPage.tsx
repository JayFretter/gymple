...
export default function BarcodeScannerPage() {
  ...
  if (!permission.granted) {
    ...
    return (
      <View className="h-full w-full bg-primary p-4 flex items-center">
        <Text className="text-2xl text-txt-primary font-semibold">Scan Barcode</Text>
  ...
  return (
    <View className="bg-card h-full p-4 flex items-center">
      <Text className="text-2xl text-txt-primary font-semibold mb-12">Scan Barcode</Text>
      <CameraView
        style={styles.camera} 
