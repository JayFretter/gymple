  ...
  return (
    <View className="bg-card w-[95%] p-4 rounded-xl flex items-center">
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false} className="mt-8">
        <View className="flex bg-[#282828] rounded-xl px-4 py-2">
        ...
        <View className="flex bg-[#282828] rounded-xl px-4 py-2 ml-4">
          <View className="flex-row items-center gap-2 self-center">
            <Text className="text-white text-2xl font-semibold">Gymple</Text>
      ...
      <Text className="text-white font-semibold text-center mt-8">Get Gymple Plus</Text>
      <TouchableOpacity
